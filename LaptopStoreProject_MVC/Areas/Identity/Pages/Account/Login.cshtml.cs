    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Email này chưa được xác nhận. Vui lòng kiểm tra email của bạn để xác nhận tài khoản!");
                    return Page();
                }
                // This doesn't count login failures towards account lockout
                // To enable password failures to trigger account lockout, set lockoutOnFailure: true
                //lockoutOnFailure: true -> để cấu hình cho việc sau bao lần đăng nhập thất bại thì tài khoản sẽ bị khóa
                ...
                else
                {
                    ...
                    ModelState.AddModelError(string.Empty, $"Số lần đăng nhập thất bại: {count}");
                    return Page();
                }
            }
